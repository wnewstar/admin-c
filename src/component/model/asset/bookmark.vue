...
export default {
    ...
    created () {
        ...
        this.api = this.$apiback.asset.bookmark
        this.bit = 0 +
    ...
    <base-model
        ...
        <template slot="create" slot-scope="base">
            ...
            <div class="form-group">
                ...
                <div class="col-md-8">
                    <input type="text" class="form-control" v-model="base.that.create.item.type">
                </div>
            </div>
            <div class="form-group">
        ...
        <template slot="modify" slot-scope="base">
            ...
            <div class="form-group">
                <label class="col-md-2 control-label">类型</label>
                <div class="col-md-8">
                    <input type="text" class="form-control" v-model="base.that.modify.item.type">
                </div>
            </div>
            <div class="form-group">
                <label class="col-md-2 control-label">名称</label>
        ...
        <template slot="search" slot-scope="base">
            ...
            <div class="form-group">
                <label class="col-md-2 control-label">类型</label>
                <div class="col-md-8">
                    <input type="text" class="form-control" v-model="base.that.search.item.type">
                </div>
            </div>
            <div class="form-group">
                <label class="col-md-2 control-label">名称</label>
        ...
        <template slot="databody" slot-scope="base">
            ...
            <td>{{ base.item.type }}</td>
            <td><a target="_blank" :href="base.item.url">{{ base.item.name }}</a></td><td>{{ base.item.time_create | datetime }}</td>
        </template>
    </base-model>
</template>
